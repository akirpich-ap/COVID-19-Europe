...
colnames(tw_distance_points_incidence) <- c("Dim.1", "Dim.2")
...
# Generating pdf output.
pdf(paste("../Plots/part02_10_dynamic_time_wapping_multidimensional_scaling_plots_incidence_gscatter_c39", graph_suffix, ".pdf", sep = ""), height = 8, width = 8)
# Defining the number of plots
ggscatter(data = data.frame(tw_distance_points_incidence), 
          xlab = "",
          ylab = "",
          xaxt = "n",
          yaxt = "n",
          ...
          y = "Dim.2", 
          fill = "lightgray",
          label = rownames(tw_distance_points_incidence),
          color = "darkorange2",
          title  = "Incidence (Dynamic Time Wrapping Distance)",
          # palette = "jco",
          size = 3, 
          # ellipse = TRUE,
          ellipse.type = "convex",
...
colnames(tw_distance_points_mortality) <- c("Dim.1", "Dim.2")
...
# Generating pdf output.
pdf(paste("../Plots/part02_10_dynamic_time_wapping_multidimensional_scaling_plots_mortality_gscatter_c39", graph_suffix, ".pdf", sep = ""), height = 8, width = 8)
# Defining the number of plots
ggscatter(data = data.frame(tw_distance_points_mortality), 
          xlab = "",
          ylab = "",
          xaxt = "n",
          yaxt = "n",
          ...
          y = "Dim.2", 
          fill = "lightgray",
          label = rownames(tw_distance_points_mortality),
          color = "firebrick3",
          title  = "Mortality (Dynamic Time Wrapping Distance)",
          # palette = "jco",
          size = 3, 
          # ellipse = TRUE,
          ellipse.type = "convex",
