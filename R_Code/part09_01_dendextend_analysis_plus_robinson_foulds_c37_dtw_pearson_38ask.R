...
for (method_current in hclust_methods)
{
  ...
  # path
  dynamic_time_wapping_hclust_incidence_path <- paste0("../R_Data/dynamic_time_wapping_hclust_incidence_c37_", method_current, ".RData") 
  dynamic_time_wapping_hclust_mortality_path <- paste0("../R_Data/dynamic_time_wapping_hclust_mortality_c37_", method_current, ".RData") 
  # loading
  ...
  # path
  pointwise_absolute_distance_hclust_incidence_path <- paste0("../R_Data/pointwise_absolute_distance_hclust_incidence_c37_", method_current, ".RData") 
  pointwise_absolute_distance_hclust_mortality_path <- paste0("../R_Data/pointwise_absolute_distance_hclust_mortality_c37_", method_current, ".RData") 
  # loading
  ...
  # path
  cross_correlation_distance_hclust_incidence_path <- paste0("../R_Data/cross_correlation_distance_hclust_incidence_c37_", method_current, ".RData") 
  cross_correlation_distance_hclust_mortality_path <- paste0("../R_Data/cross_correlation_distance_hclust_mortality_c37_", method_current, ".RData") 
  # loading
  ...
  # path
  auxilliary_data_hclust_complete_path          <- paste0("../R_Data/auxilliary_data_hclust_complete_c37_", method_current, ".RData") 
  auxilliary_data_hclust_demographics_path      <- paste0("../R_Data/auxilliary_data_hclust_demographics_c37_", method_current, ".RData") 
  auxilliary_data_hclust_population_health_path <- paste0("../R_Data/auxilliary_data_hclust_population_health_c37_", method_current, ".RData") 
  # loading
  ...
  # dynamic_time_wapping_hclust
  # path
  dynamic_time_wapping_hclust_vaccination_path <- paste0("../R_Data/dynamic_time_wapping_hclust_vaccination_c37_", method_current, ".RData") 
  # loading
  ...
  # pointwise_absolute_distance_hclust
  # path
  pointwise_absolute_distance_hclust_vaccination_path <- paste0("../R_Data/pointwise_absolute_distance_hclust_vaccination_c37_", method_current, ".RData") 
  # loading
  ...
  # cross_correlation_distance_hclust
  # path
  cross_correlation_distance_hclust_vaccination_path <- paste0("../R_Data/cross_correlation_distance_hclust_vaccination_c37_", method_current, ".RData") 
  # loading
  ...
  # path
  strain_distrubution_distance_hclust_genetics_path <- paste0("../R_Data/strain_distrubution_distance_hclust_genetics_c37_", method_current, ".RData") 
  # loading
...
#     paste0("dynamic_time_wapping_hclust_incidence_c37_", method_current,"$height <- 1000 * dynamic_time_wapping_hclust_incidence_c37_", method_current,"$height/max(dynamic_time_wapping_hclust_incidence_c37_", method_current, "$height)") 
#   dynamic_time_wapping_hclust_mortality_standartization_text <- 
#     paste0("dynamic_time_wapping_hclust_mortality_c37_", method_current,"$height <- 1000 * dynamic_time_wapping_hclust_mortality_c37_", method_current,"$height/max(dynamic_time_wapping_hclust_mortality_c37_", method_current, "$height)") 
#   # running 
...
#     paste0("pointwise_absolute_distance_hclust_incidence_c37_", method_current,"$height <- 1000 * pointwise_absolute_distance_hclust_incidence_c37_", method_current,"$height/max(pointwise_absolute_distance_hclust_incidence_c37_", method_current, "$height)") 
#   pointwise_absolute_distance_hclust_mortality_standartization_text <- 
#     paste0("pointwise_absolute_distance_hclust_mortality_c37_", method_current,"$height <- 1000 * pointwise_absolute_distance_hclust_mortality_c37_", method_current,"$height/max(pointwise_absolute_distance_hclust_mortality_c37_", method_current, "$height)") 
#   # running 
...
#     paste0("auxilliary_data_hclust_complete_c37_", method_current,"$height <- 1000 * auxilliary_data_hclust_complete_c37_", method_current,"$height/max(auxilliary_data_hclust_complete_c37_", method_current, "$height)") 
#   auxilliary_data_hclust_demographics_standartization_text      <- 
#     paste0("auxilliary_data_hclust_demographics_c37_", method_current,"$height <- 1000 * auxilliary_data_hclust_demographics_c37_", method_current,"$height/max(auxilliary_data_hclust_demographics_c37_", method_current, "$height)") 
#   auxilliary_data_hclust_population_health_standartization_text <- 
#     paste0("auxilliary_data_hclust_population_health_c37_", method_current,"$height <- 1000 * auxilliary_data_hclust_population_health_c37_", method_current,"$height/max(auxilliary_data_hclust_population_health_c37_", method_current, "$height)") 
#   # run
...
#     paste0("dynamic_time_wapping_hclust_vaccination_c37_", method_current,"$height <- 1000 * dynamic_time_wapping_hclust_vaccination_c37_", method_current,"$height/max(dynamic_time_wapping_hclust_vaccination_c37_", method_current, "$height)") 
#   # running 
...
#     paste0("pointwise_absolute_distance_hclust_vaccination_c37_", method_current,"$height <- 1000 * pointwise_absolute_distance_hclust_vaccination_c37_", method_current,"$height/max(pointwise_absolute_distance_hclust_vaccination_c37_", method_current, "$height)") 
#   # running 
...
# 1 COVID-19 Mortality (Dynamic Time Wrapping) vs Population Health
design_frame$dend1[1]   <- "dynamic_time_wapping_hclust_mortality_c37_dengrogram_current"
design_frame$title1[1]  <- "COVID-19 Mortality (Dynamic Time Wrapping)"
design_frame$title1_short[1]  <- "MOR"
design_frame$file1[1]   <- "mortality_dtw"
#
design_frame$dend2[1]   <- "auxilliary_data_hclust_population_health_c37_dengrogram_current"
...
# 2 COVID-19 Mortality (Dynamic Time Wrapping) vs COVID-19 Vaccinations (Dynamic Time Wrapping)
design_frame$dend1[2]   <- "dynamic_time_wapping_hclust_mortality_c37_dengrogram_current"
design_frame$title1[2]  <- "COVID-19 Mortality (Dynamic Time Wrapping)"
design_frame$title1_short[2]  <- "MOR"
design_frame$file1[2]   <- "mortality_dtw"
#
design_frame$dend2[2]  <- "dynamic_time_wapping_hclust_vaccination_c37_dengrogram_current"
design_frame$title2[2] <- "COVID-19 Vaccinations (Dynamic Time Wrapping)"
design_frame$title2_short[2]  <- "VAC"
design_frame$file2[2]  <- "vaccinations_dtw"
#
design_frame$same_elements[2]   <- 1


# 3 COVID-19 Mortality (Dynamic Time Wrapping) vs Travel Data 2016
design_frame$dend1[3]   <- "dynamic_time_wapping_hclust_mortality_c37_dengrogram_current"
design_frame$title1[3]  <- "COVID-19 Mortality (Dynamic Time Wrapping)"
design_frame$title1_short[3]  <- "MOR"
design_frame$file1[3]   <- "mortality_dtw"
#
...
#
design_frame$same_elements[3]   <- 1


# 4 COVID-19 Vaccinations (Dynamic Time Wrapping) vs Population Health and Socio???Demographic Data
design_frame$dend1[4]  <- "dynamic_time_wapping_hclust_vaccination_c37_dengrogram_current"
design_frame$title1[4] <- "COVID-19 Vaccinations (Dynamic Time Wrapping)"
design_frame$title1_short[4]  <- "VAC"
design_frame$file1[4]  <- "vaccinations_dtw"
#
design_frame$dend2[4]   <- "auxilliary_data_hclust_demographics_c37_dengrogram_current"
...
# 5 COVID-19 Vaccinations (Dynamic Time Wrapping) vs Population Health and Socio???Demographic Data
design_frame$dend1[5]  <- "dynamic_time_wapping_hclust_vaccination_c37_dengrogram_current"
design_frame$title1[5] <- "COVID-19 Vaccinations (Dynamic Time Wrapping)"
design_frame$title1_short[5]  <- "VAC"
design_frame$file1[5]  <- "vaccinations_dtw"
#
...
#
design_frame$same_elements[5]   <- 1


# 6 Population Health and Socio???Demographic Data vs COVID-19 Incidence (Dynamic Time Wrapping)
design_frame$dend1[6]   <- "auxilliary_data_hclust_complete_c37_dengrogram_current"
...
#
design_frame$dend2[6]   <- "dynamic_time_wapping_hclust_incidence_c37_dengrogram_current"
design_frame$title2[6]  <- "COVID-19 Incidence (Dynamic Time Wrapping)"
design_frame$title2_short[6]  <- "INC"
design_frame$file2[6]   <- "incidence_dtw"
#
design_frame$same_elements[6]   <- 1


# 7 Mobility Data Average for 2011-2016 vs COVID-19 Incidence (Dynamic Time Wrapping)
...
#
design_frame$dend2[7]   <- "dynamic_time_wapping_hclust_incidence_c37_dengrogram_current"
design_frame$title2[7]  <- "COVID-19 Incidence (Dynamic Time Wrapping)"
design_frame$title2_short[7]  <- "INC"
design_frame$file2[7]   <- "incidence_dtw"
#
design_frame$same_elements[7]   <- 1


# 8 COVID-19 Vaccinations (Dynamic Time Wrapping) vs COVID-19 Mortality (Dynamic Time Wrapping)
design_frame$dend1[8]  <- "dynamic_time_wapping_hclust_vaccination_c37_dengrogram_current"
design_frame$title1[8] <- "COVID-19 Vaccinations (Dynamic Time Wrapping)"
design_frame$title1_short[8]  <- "VAC"
design_frame$file1[8]  <- "vaccinations_dtw"
#
design_frame$dend2[8]   <- "dynamic_time_wapping_hclust_mortality_c37_dengrogram_current"
design_frame$title2[8]  <- "COVID-19 Mortality (Dynamic Time Wrapping)"
design_frame$title2_short[8]  <- "MOR"
design_frame$file2[8]   <- "mortality_dtw"
#
design_frame$same_elements[8]   <- 1


# 9 COVID-19 Incidence (Dynamic Time Wrapping) vs COVID-19 Vaccinations (Dynamic Time Wrapping)
design_frame$dend1[9]  <- "dynamic_time_wapping_hclust_incidence_c37_dengrogram_current"
design_frame$title1[9] <- "COVID-19 Incidence (Dynamic Time Wrapping)"
design_frame$title1_short[9]  <- "INC"
design_frame$file1[9]  <- "incidence_dtw"
#
design_frame$dend2[9]   <- "dynamic_time_wapping_hclust_vaccination_c37_dengrogram_current"
design_frame$title2[9]  <- "COVID-19 Vaccinations (Dynamic Time Wrapping)"
design_frame$title2_short[9]  <- "VAC"
design_frame$file2[9]   <- "vaccinations_dtw"
#
design_frame$same_elements[9]   <- 1


# 10 COVID-19 Incidence (Dynamic Time Wrapping) vs COVID-19 Genetic Diversity (Strain Distribution Distance)
design_frame$dend1[10]  <- "dynamic_time_wapping_hclust_incidence_c37_dengrogram_current"
design_frame$title1[10] <- "COVID-19 Incidence (Dynamic Time Wrapping)"
design_frame$title1_short[10]  <- "INC"
design_frame$file1[10]  <- "incidence_dtw"
#
design_frame$dend2[10]   <- "strain_distrubution_distance_hclust_genetics_c37_dengrogram_current"
...
for (method_current in hclust_methods)
{
  ...
  dynamic_time_wapping_hclust_incidence_dengrogram_text <- 
    paste0("dynamic_time_wapping_hclust_incidence_c37_dengrogram_current <- as.dendrogram(dynamic_time_wapping_hclust_incidence_c37_", method_current, ")") 
  dynamic_time_wapping_hclust_mortality_dengrogram_text <- 
    paste0("dynamic_time_wapping_hclust_mortality_c37_dengrogram_current <- as.dendrogram(dynamic_time_wapping_hclust_mortality_c37_", method_current, ")") 
  # running 
  ...
  pointwise_absolute_distance_hclust_incidence_dengrogram_text <- 
    paste0("pointwise_absolute_distance_hclust_incidence_c37_dengrogram_current <- as.dendrogram(pointwise_absolute_distance_hclust_incidence_c37_", method_current, ")") 
  pointwise_absolute_distance_hclust_mortality_dengrogram_text <- 
    paste0("pointwise_absolute_distance_hclust_mortality_c37_dengrogram_current <- as.dendrogram(pointwise_absolute_distance_hclust_mortality_c37_", method_current, ")") 
  # running 
  ...
  cross_correlation_distance_hclust_incidence_dengrogram_text <- 
    paste0("cross_correlation_distance_hclust_incidence_c37_dengrogram_current <- as.dendrogram(cross_correlation_distance_hclust_incidence_c37_", method_current, ")") 
  cross_correlation_distance_hclust_mortality_dengrogram_text <- 
    paste0("cross_correlation_distance_hclust_mortality_c37_dengrogram_current <- as.dendrogram(cross_correlation_distance_hclust_mortality_c37_", method_current, ")") 
  # running 
  ...
  # auxilliary_data_hclust_complete
  # text
  auxilliary_data_hclust_complete_dengrogram_text          <- paste0("auxilliary_data_hclust_complete_c37_dengrogram_current <- as.dendrogram(auxilliary_data_hclust_complete_c37_", method_current, ")")
  auxilliary_data_hclust_demographics_dengrogram_text      <- paste0("auxilliary_data_hclust_demographics_c37_dengrogram_current <- as.dendrogram(auxilliary_data_hclust_demographics_c37_", method_current, ")") 
  auxilliary_data_hclust_population_health_dengrogram_text <- paste0("auxilliary_data_hclust_population_health_c37_dengrogram_current <- as.dendrogram(auxilliary_data_hclust_population_health_c37_", method_current, ")") 
  # run
  ...
  # dynamic_time_wapping_hclust
  # text
  dynamic_time_wapping_hclust_vaccination_dengrogram_text <- paste0("dynamic_time_wapping_hclust_vaccination_c37_dengrogram_current <- as.dendrogram(dynamic_time_wapping_hclust_vaccination_c37_", method_current, ")") 
  # running 
  ...
  # pointwise_absolute_distance_hclust
  # text
  pointwise_absolute_distance_hclust_vaccination_dengrogram_text <- paste0("pointwise_absolute_distance_hclust_vaccination_c37_dengrogram_current <- as.dendrogram(pointwise_absolute_distance_hclust_vaccination_c37_", method_current, ")") 
  # running 
  ...
  # cross_correlation_distance_hclust
  # text
  cross_correlation_distance_hclust_vaccination_dengrogram_text <- paste0("cross_correlation_distance_hclust_vaccination_c37_dengrogram_current <- as.dendrogram(cross_correlation_distance_hclust_vaccination_c37_", method_current, ")") 
  # running 
  ...
  # strain_distrubution_distance_hclust
  # text
  strain_distrubution_distance_hclust_genetics_dengrogram_text <- paste0("strain_distrubution_distance_hclust_genetics_c37_dengrogram_current <- as.dendrogram(strain_distrubution_distance_hclust_genetics_c37_", method_current, ")") 
  # running 
  ...
  for ( index_current in c(1:dim(design_frame)[1]) )
  {
    ...
    pdf(paste("../Plots/part09_01_trees_", design_frame$file1[index_current],"_vs_", design_frame$file2[index_current],"_", method_current, "_c37.pdf", sep = ""), height = 7.25, width = 12)
  ...
  for ( index_current in c(1:dim(design_frame)[1]) )
  {
    ...
    # Generating pdf output.
    pdf(paste("../Plots/part09_01_trees2_", design_frame$file1[index_current],"_vs_", design_frame$file2[index_current],"_", method_current, "_c37.pdf", sep = ""), height = 7.25, width = 12)
  ...
  for ( index_current in c(1:dim(design_frame)[1]) )
  {
    ...
    # Generating pdf output.
    pdf(paste("../Plots/part09_01_trees3_", design_frame$file1[index_current],"_vs_", design_frame$file2[index_current],"_", method_current, "_c37.pdf", sep = ""), height = 7.25, width = 12)
    ...
    # Fix 2024.10.14.
    # Using "step2side" as recommended int the article below but at higher computation cost
    # https://academic.oup.com/bioinformaticsadvances/article/2/1/vbac014/6539778    
    # The default ones used before was "DendSer"
    # c("labels", "ladderize", "random", "step1side", "step2side", "DendSer")
    # Plot them together

    dend1_dend2_list %>% untangle(method = "step2side") %>%     
    tanglegram(, 
  ...
  for ( index_current in c(1:dim(design_frame)[1]) )
  {
    ...
    if ( (design_frame$same_elements[index_current] == 1) && (method_current != "median") )
    {
      ...
      # Generating pdf output.
      pdf(paste("../Plots/part09_01_fm_plot_", design_frame$file1[index_current],"_vs_", design_frame$file2[index_current],"_", method_current, "_c37.pdf", sep = ""), height = 7, width = 11)
  ...
  for ( correlation_current in c(1:length(correlations_list)) )
  {
    ...
    for ( visualization_current in c(1:length(visualizations_list)) )
    {
      ...
      # Generating pdf output.
      pdf(paste("../Plots/part09_01_corrplot_dtw_all_lower_", method_current, "_", correlations_list[correlation_current], "_", visualizations_list[visualization_current], "_pearson_c37.pdf", sep = ""), height = 10, width = 10)
      ...
      # Generating pdf output.
      pdf(paste("../Plots/part09_01_corrplot_dtw_all_full_", method_current, "_", correlations_list[correlation_current], "_", visualizations_list[visualization_current], "_pearson_c37.pdf", sep = ""), height = 10, width = 10)
  ...
  for ( visualization_current in c(1:length(visualizations_list)) )
  {
    ...
    # Generating pdf output.
    pdf(paste("../Plots/part09_01_corrplot_dtw_all_lower_", method_current, "_cophenetic_and_baker_" , visualizations_list[visualization_current], "_pearson_c37.pdf", sep = ""), height = 10, width = 20)
    ...
    # Exporting CSV files
    cor_dendlist_current_csv_path = paste0("../R_Output/part09_01_correlation_cophenetic_dtw_", method_current, "_c37.csv")
    ...
    # Exporting TEX files
    cor_dendlist_current_xtable <- xtable( x = cor_dendlist_current_frame[,-1], digits = 2 )  
    # Exporting as tex file
    # Creating a path 
    cor_dendlist_current_xtable_path_out <- paste0("../R_Output/part09_01_correlation_cophenetic_dtw_", method_current, "_c37.tex")
    # Printing
    print.xtable( x = cor_dendlist_current_xtable, type="latex", file = cor_dendlist_current_xtable_path_out, include.rownames = TRUE )
    ...
    # Exporting CSV files
    cor_dendlist_current_csv_path = paste0("../R_Output/part09_01_correlation_baker_dtw_", method_current, "_c37.csv")
    cor_dendlist_current_frame <- data.frame(Data = rownames(cor_dendlist_current), cor_dendlist_current)
    names(cor_dendlist_current_frame) <- c("Data", rownames(cor_dendlist_current))
    write.table(x = cor_dendlist_current_frame, file = cor_dendlist_current_csv_path, sep = ",", row.names = FALSE, col.names = TRUE)
    ...
    # Exporting as tex file
    # Creating a path 
    cor_dendlist_current_xtable_path_out <- paste0("../R_Output/part09_01_correlation_baker_dtw_", method_current, "_c37.tex")
    # Printing
    print.xtable( x = cor_dendlist_current_xtable, type="latex", file = cor_dendlist_current_xtable_path_out, include.rownames = TRUE )
    ...
    # Generating pdf output.
    pdf(paste("../Plots/part09_01_corrplot_dtw_all_upper_", method_current, "_cophenetic_and_baker_" , visualizations_list[visualization_current], "_pearson_c37.pdf", sep = ""), height = 10, width = 20)
    # par(par(mfrow = c(1, 2)), mar = c(16.5, 5.1, 6, 2.1))
    par(mfrow = c(1, 2))
    ...
    # Generating pdf output.
    pdf(paste("../Plots/part09_01_corrplot_dtw_all_full_", method_current, "_cophenetic_and_baker_" , visualizations_list[visualization_current], "_pearson_c37.pdf", sep = ""), height = 10, width = 20)
    # par(par(mfrow = c(1, 2)), mar = c(16.5, 5.1, 6, 2.1))
    par(mfrow = c(1, 2))
    ...
    # Fix 2024.10.14.
    # Providing a scatter plot of points based on the reviewers request.        
    
    # cophenetic
    cor_dendlist_current_copenetic <- cor.dendlist(dend = dendlist_of_dendrograms, method = "cophenetic" )
    
    # baker
    cor_dendlist_current_baker     <- cor.dendlist(dend = dendlist_of_dendrograms, method = "baker" )
    
    # Absolute disagreement.
    cor_dendlist_current <- cor_dendlist_current_copenetic - cor_dendlist_current_baker
    
    
    # Generating pdf output.
    pdf(paste("../Plots/part09_01_corrdisagr_dtw_all_full_", method_current, "_cophenetic_and_baker_" , visualizations_list[visualization_current], "_pearson_c37.pdf", sep = ""), height = 10.75, width = 10)
    ...
    mtext(text = paste0("Cophenetic - Baker Metric Differences for Trees"),
          side = 3,
          line = - 2.5,
          cex = 1.35, 
          outer = TRUE)
    ...
    # Fix 2024.10.17.
    # Providing a table of differences based on the reviewers request.        
    cor_dendlist_current_xtable <- xtable( x = cor_dendlist_current, digits = 2 )  
    # Exporting as tex file
    # Creating a path 
    cor_dendlist_current_xtable_path_out <- paste0("../R_Output/part09_01_corrtable_dendlist_difference_dtw_", method_current, "_c37.tex")
    # Printing
    print.xtable( x = cor_dendlist_current_xtable, type="latex", file = cor_dendlist_current_xtable_path_out, include.rownames = TRUE )
    
    # Computing the correlation coefficient.
    cortest_resutlt <- cor.test(x = as.vector(cor_dendlist_current_copenetic), y = as.vector(cor_dendlist_current_baker) )
    cor_dendlist_current_copenetic_vs_baker <- data.frame( correlation  = cortest_resutlt$estimate, low95_ci = cortest_resutlt$conf.int[1], high95_ci = cortest_resutlt$conf.int[2] )
    
    # Exporting as csv file
    # Creating a path 
    cor_dendlist_current_copenetic_vs_baker_csv_path <- paste0("../R_Output/part09_01_corrvalue_dendlist_difference_dtw_", method_current, "_c37.csv")
    # Writing
    write.table(x = cor_dendlist_current_copenetic_vs_baker, file = cor_dendlist_current_copenetic_vs_baker_csv_path, sep = ",", row.names = FALSE)
    ...
    for (correlation_threshold in correlation_threshold_list)
    {
      ...
      pdf(paste("../Plots/part09_01_graph_dtw_fr_", method_current, "_cophenetic_and_baker_rho_thold_", correlation_threshold, "_pearson_c37.pdf", sep = ""), height = 10, width = 20)
      # par(par(mfrow = c(1, 2)), mar = c(16.5, 5.1, 6, 2.1))
      par(mfrow = c(1, 2))
      ...
      pdf(paste("../Plots/part09_01_graph_dtw_kk_", method_current, "_cophenetic_and_baker_rho_thold_", correlation_threshold, "_pearson_c37.pdf", sep = ""), height = 10, width = 20)
      # par(par(mfrow = c(1, 2)), mar = c(16.5, 5.1, 6, 2.1))
      par(mfrow = c(1, 2))
  ...
  sink(paste0("../R_Output/part09_01_rob_foulds_dtw_", method_current, "_c37.txt"))
  ...
  # Exporting CSV files
  # Regular
  robinson_foulds_current_csv_path = paste0("../R_Output/part09_01_rob_foulds_dtw_", method_current, "_c37.csv")
  write.table(x = robinson_foulds_current, file = robinson_foulds_current_csv_path, sep = ",", row.names = TRUE)
  # Standardized
  robinson_foulds_standardized_current_csv_path = paste0("../R_Output/part09_01_rob_foulds_dtw_standardized_", method_current, "_c37.csv")
  ...
  # Exporting as tex file
  # Creating a path 
  robinson_foulds_current_xtable_path_out <- paste0("../R_Output/part09_01_rob_foulds_dtw_", method_current, "_c37.tex")
  # Printing
  ...
  # Exporting as tex file
  # Creating a path 
  robinson_foulds_standardized_current_xtable_path_out <- paste0("../R_Output/part09_01_rob_foulds_dtw_standardized_", method_current, "_c37.tex")
  # Printing
