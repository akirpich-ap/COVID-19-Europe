...
design_frame$dend1[1]   <- "cross_correlation_distance_hclust_mortality_c37_dengrogram_current"
...
design_frame$dend1[2]   <- "cross_correlation_distance_hclust_mortality_c37_dengrogram_current"
...
#
design_frame$dend2[2]  <- "cross_correlation_distance_hclust_vaccination_c37_dengrogram_current"
...
design_frame$dend1[3]   <- "cross_correlation_distance_hclust_mortality_c37_dengrogram_current"
...
design_frame$dend1[4]  <- "cross_correlation_distance_hclust_vaccination_c37_dengrogram_current"
...
design_frame$dend1[5]  <- "cross_correlation_distance_hclust_vaccination_c37_dengrogram_current"
...
#
design_frame$dend2[6]   <- "cross_correlation_distance_hclust_incidence_c37_dengrogram_current"
...
#
design_frame$dend2[7]   <- "cross_correlation_distance_hclust_incidence_c37_dengrogram_current"
...
design_frame$dend1[8]  <- "cross_correlation_distance_hclust_vaccination_c37_dengrogram_current"
...
#
design_frame$dend2[8]   <- "cross_correlation_distance_hclust_mortality_c37_dengrogram_current"
...
design_frame$dend1[9]  <- "cross_correlation_distance_hclust_incidence_c37_dengrogram_current"
...
#
design_frame$dend2[9]   <- "cross_correlation_distance_hclust_vaccination_c37_dengrogram_current"
...
design_frame$dend1[10]  <- "cross_correlation_distance_hclust_incidence_c37_dengrogram_current"
...
for (method_current in hclust_methods)
{
  ...
  for ( correlation_current in c(1:length(correlations_list)) )
  {
    ...
    for ( visualization_current in c(1:length(visualizations_list)) )
    {
      ...
      # Generating pdf output.
      pdf(paste("../Plots/part09_01_corrplot_ccd_all_lower_", method_current, "_", correlations_list[correlation_current], "_", visualizations_list[visualization_current], "_pearson_c37.pdf", sep = ""), height = 10, width = 10)
      ...
      # Generating pdf output.
      pdf(paste("../Plots/part09_01_corrplot_ccd_all_full_", method_current, "_", correlations_list[correlation_current], "_", visualizations_list[visualization_current], "_pearson_c37.pdf", sep = ""), height = 10, width = 10)
  ...
  for ( visualization_current in c(1:length(visualizations_list)) )
  {
    ...
    # Generating pdf output.
    pdf(paste("../Plots/part09_01_corrplot_ccd_all_lower_", method_current, "_cophenetic_and_baker_" , visualizations_list[visualization_current], "_pearson_c37.pdf", sep = ""), height = 10, width = 20)
    ...
    # Exporting CSV files
    cor_dendlist_current_csv_path = paste0("../R_Output/part09_01_correlation_cophenetic_ccd_", method_current, "_c37.csv")
    ...
    # Creating a path 
    cor_dendlist_current_xtable_path_out <- paste0("../R_Output/part09_01_correlation_cophenetic_ccd_", method_current, "_c37.tex")
    # Printing
    ...
    # Exporting CSV files
    cor_dendlist_current_csv_path = paste0("../R_Output/part09_01_correlation_baker_ccd_", method_current, "_c37.csv")
    cor_dendlist_current_frame <- data.frame(Data = rownames(cor_dendlist_current), cor_dendlist_current)
    names(cor_dendlist_current_frame) <- c("Data", rownames(cor_dendlist_current))
    write.table(x = cor_dendlist_current_frame, file = cor_dendlist_current_csv_path, sep = ",", row.names = FALSE, col.names = TRUE)
    ...
    # Exporting as tex file
    # Creating a path 
    cor_dendlist_current_xtable_path_out <- paste0("../R_Output/part09_01_correlation_baker_ccd_", method_current, "_c37.tex")
    # Printing
    print.xtable( x = cor_dendlist_current_xtable, type="latex", file = cor_dendlist_current_xtable_path_out, include.rownames = TRUE )
    ...
    # Generating pdf output.
    pdf(paste("../Plots/part09_01_corrplot_ccd_all_upper_", method_current, "_cophenetic_and_baker_" , visualizations_list[visualization_current], "_pearson_c37.pdf", sep = ""), height = 10, width = 20)
    # par(par(mfrow = c(1, 2)), mar = c(16.5, 5.1, 6, 2.1))
    par(mfrow = c(1, 2))
    ...
    # Generating pdf output.
    pdf(paste("../Plots/part09_01_corrplot_ccd_all_full_", method_current, "_cophenetic_and_baker_" , visualizations_list[visualization_current], "_pearson_c37.pdf", sep = ""), height = 10, width = 20)
    # par(par(mfrow = c(1, 2)), mar = c(16.5, 5.1, 6, 2.1))
    par(mfrow = c(1, 2))
    ...
    # Generating pdf output.
    pdf(paste("../Plots/part09_01_corrdisagr_ccd_all_full_", method_current, "_cophenetic_and_baker_" , visualizations_list[visualization_current], "_pearson_c37.pdf", sep = ""), height = 10.75, width = 10)
    ...
    # Exporting as tex file
    # Creating a path 
    cor_dendlist_current_xtable_path_out <- paste0("../R_Output/part09_01_corrtable_dendlist_difference_ccd_", method_current, "_c37.tex")
    # Printing
    print.xtable( x = cor_dendlist_current_xtable, type="latex", file = cor_dendlist_current_xtable_path_out, include.rownames = TRUE )
    ...
    # Creating a path 
    cor_dendlist_current_copenetic_vs_baker_csv_path <- paste0("../R_Output/part09_01_corrvalue_dendlist_difference_ccd_", method_current, "_c37.csv")
    # Writing
    ...
    for (correlation_threshold in correlation_threshold_list)
    {
      ...
      pdf(paste("../Plots/part09_01_graph_ccd_fr_", method_current, "_cophenetic_and_baker_rho_thold_", correlation_threshold, "_pearson_c37.pdf", sep = ""), height = 10, width = 20)
      # par(par(mfrow = c(1, 2)), mar = c(16.5, 5.1, 6, 2.1))
      par(mfrow = c(1, 2))
      ...
      pdf(paste("../Plots/part09_01_graph_ccd_kk_", method_current, "_cophenetic_and_baker_rho_thold_", correlation_threshold, "_pearson_c37.pdf", sep = ""), height = 10, width = 20)
      # par(par(mfrow = c(1, 2)), mar = c(16.5, 5.1, 6, 2.1))
      par(mfrow = c(1, 2))
  ...
  sink(paste0("../R_Output/part09_01_rob_foulds_ccd_", method_current, "_c37.txt"))
  ...
  # Exporting CSV files
  # Regular
  robinson_foulds_current_csv_path = paste0("../R_Output/part09_01_rob_foulds_ccd_", method_current, "_c37.csv")
  write.table(x = robinson_foulds_current, file = robinson_foulds_current_csv_path, sep = ",", row.names = TRUE)
  # Standardized
  robinson_foulds_standardized_current_csv_path = paste0("../R_Output/part09_01_rob_foulds_ccd_standardized_", method_current, "_c37.csv")
  ...
  # Exporting as tex file
  # Creating a path 
  robinson_foulds_current_xtable_path_out <- paste0("../R_Output/part09_01_rob_foulds_ccd_", method_current, "_c37.tex")
  # Printing
  ...
  # Exporting as tex file
  # Creating a path 
  robinson_foulds_standardized_current_xtable_path_out <- paste0("../R_Output/part09_01_rob_foulds_ccd_standardized_", method_current, "_c37.tex")
  # Printing
