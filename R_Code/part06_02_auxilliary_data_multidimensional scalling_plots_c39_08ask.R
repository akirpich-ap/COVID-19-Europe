...
pdf(paste("../Plots/part06_02_auxilliary_data_multidimensional_scaling_plots_complete_c39", graph_suffix, ".pdf", sep = ""), height = 16, width = 16)
...
for (method_current in hclust_methods)
{
  ...
  # Creating object
  create_object_command <- paste0( "auxilliary_data_hclust_complete_c39_", method_current, " <- cluster_complete" )
  eval(parse(text = create_object_command))    
  
  # Saving object
  # Path to save
  path_to_save_object <- paste0("../R_Data/auxilliary_data_hclust_complete_c39_", method_current, ".RData") 
  # Saving process
  saving_process_command <- paste0( "save( auxilliary_data_hclust_complete_c39_", method_current, ", file = path_to_save_object )" )
  ...
  # Generating pdf output.
  pdf(paste("../Plots/part06_02_auxilliary_data_multidimensional_scaling_plots_clusters_complete_c39_", method_current, graph_suffix, ".pdf", sep = ""), height = 52, width = 40)
  # Defining the number of plots
  par(mfrow = c(1, 1))
...
# Generating pdf output.
pdf(paste("../Plots/part06_02_auxilliary_data_multidimensional_scaling_plots_population_health_c39", graph_suffix, ".pdf", sep = ""), height = 16, width = 16)
# Defining the number of plots
plot(
...
for (method_current in hclust_methods)
{
  ...
  # Creating object
  create_object_command <- paste0( "auxilliary_data_hclust_population_health_c39_", method_current, " <- cluster_population_health" )
  eval(parse(text = create_object_command))    
  
  # Saving object
  # Path to save
  path_to_save_object <- paste0("../R_Data/auxilliary_data_hclust_population_health_c39_", method_current, ".RData") 
  # Saving process
  saving_process_command <- paste0( "save( auxilliary_data_hclust_population_health_c39_", method_current, ", file = path_to_save_object )" )
  eval(parse(text = saving_process_command))    
  ...
  # Generating pdf output.
  pdf(paste("../Plots/part06_02_auxilliary_data_multidimensional_scaling_plots_clusters_population_health_c39_", method_current, graph_suffix, ".pdf", sep = ""), height = 52, width = 40)
  # Defining the number of plots
  par(mfrow = c(1, 1))
...
# Generating pdf output.
pdf(paste("../Plots/part06_02_auxilliary_data_multidimensional_scaling_plots_demographics_c39", graph_suffix, ".pdf", sep = ""), height = 16, width = 16)
# Defining the number of plots
plot(
...
for (method_current in hclust_methods)
{
  ...
  # Creating object
  create_object_command <- paste0( "auxilliary_data_hclust_demographics_c39_", method_current, " <- cluster_demographics" )
  eval(parse(text = create_object_command))    
  
  # Saving object
  # Path to save
  path_to_save_object <- paste0("../R_Data/auxilliary_data_hclust_demographics_c39_", method_current, ".RData") 
  # Saving process
  saving_process_command <- paste0( "save( auxilliary_data_hclust_demographics_c39_", method_current, ", file = path_to_save_object )" )
  eval(parse(text = saving_process_command))    
  ...
  # Generating pdf output.
  pdf(paste("../Plots/part06_02_auxilliary_data_multidimensional_scaling_plots_clusters_demographics_c39_", method_current, graph_suffix, ".pdf", sep = ""), height = 52, width = 40)
  # Defining the number of plots
  par(mfrow = c(1, 1))
