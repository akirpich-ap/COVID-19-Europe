...
for (method_current in hclust_methods)
{
  ...
  for ( correlation_current in c(1:length(correlations_list)) )
  {
    ...
    for ( visualization_current in c(1:length(visualizations_list)) )
    {
      ...
      # Generating pdf output.
      pdf(paste("../Plots/part09_01_corrplot_all_lower_", method_current, "_", correlations_list[correlation_current], "_", visualizations_list[visualization_current], "_pearson_c37.pdf", sep = ""), height = 10, width = 10)
      ...
      # Generating pdf output.
      pdf(paste("../Plots/part09_01_corrplot_all_full_", method_current, "_", correlations_list[correlation_current], "_", visualizations_list[visualization_current], "_pearson_c37.pdf", sep = ""), height = 10, width = 10)
  ...
  for ( visualization_current in c(1:length(visualizations_list)) )
  {
    ...
    # Generating pdf output.
    pdf(paste("../Plots/part09_01_corrplot_all_lower_", method_current, "_cophenetic_and_baker_" , visualizations_list[visualization_current], "_pearson_c37.pdf", sep = ""), height = 10, width = 20)
    ...
    # Generating pdf output.
    pdf(paste("../Plots/part09_01_corrplot_all_upper_", method_current, "_cophenetic_and_baker_" , visualizations_list[visualization_current], "_pearson_c37.pdf", sep = ""), height = 10, width = 20)
    # par(par(mfrow = c(1, 2)), mar = c(16.5, 5.1, 6, 2.1))
    par(mfrow = c(1, 2))
    ...
    # Generating pdf output.
    pdf(paste("../Plots/part09_01_corrplot_all_full_", method_current, "_cophenetic_and_baker_" , visualizations_list[visualization_current], "_pearson_c37.pdf", sep = ""), height = 10, width = 20)
    # par(par(mfrow = c(1, 2)), mar = c(16.5, 5.1, 6, 2.1))
    par(mfrow = c(1, 2))
    ...
    for (correlation_threshold in correlation_threshold_list)
    {
      ...
      pdf(paste("../Plots/part09_01_graph_fr_", method_current, "_cophenetic_and_baker_rho_thold_", correlation_threshold, "_pearson_c37.pdf", sep = ""), height = 10, width = 20)
      # par(par(mfrow = c(1, 2)), mar = c(16.5, 5.1, 6, 2.1))
      par(mfrow = c(1, 2))
      ...
      pdf(paste("../Plots/part09_01_graph_kk_", method_current, "_cophenetic_and_baker_rho_thold_", correlation_threshold, "_pearson_c37.pdf", sep = ""), height = 10, width = 20)
      # par(par(mfrow = c(1, 2)), mar = c(16.5, 5.1, 6, 2.1))
      par(mfrow = c(1, 2))
