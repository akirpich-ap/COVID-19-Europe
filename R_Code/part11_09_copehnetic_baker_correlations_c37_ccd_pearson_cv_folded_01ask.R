...
for( cv_current_index in c(1:dim(part11_01_cross_validation_samples_to_keep)[1]) )
{
  ...
  for (method_current in hclust_methods)
  {
    ...
    # path
    cross_correlation_distance_hclust_incidence_path <- paste0("../R_Data/cross_correlation_distance_hclust_incidence_c37_", method_current, "_fold_", cv_current_index, ".RData") 
    cross_correlation_distance_hclust_mortality_path <- paste0("../R_Data/cross_correlation_distance_hclust_mortality_c37_", method_current, "_fold_", cv_current_index, ".RData") 
    # loading
    ...
    # cross_correlation_distance_hclust
    # path
    cross_correlation_distance_hclust_vaccination_path <- paste0("../R_Data/cross_correlation_distance_hclust_vaccination_c37_", method_current, "_fold_", cv_current_index, ".RData") 
    # loading
    ...
    cross_correlation_distance_hclust_incidence_dengrogram_text <- 
      paste0("cross_correlation_distance_hclust_incidence_c37_dengrogram_current <- as.dendrogram(cross_correlation_distance_hclust_incidence_c37_", method_current, "_fold_", cv_current_index, ")") 
    cross_correlation_distance_hclust_mortality_dengrogram_text <- 
      paste0("cross_correlation_distance_hclust_mortality_c37_dengrogram_current <- as.dendrogram(cross_correlation_distance_hclust_mortality_c37_", method_current, "_fold_", cv_current_index, ")") 
    # running 
    ...
    cross_correlation_distance_hclust_vaccination_dengrogram_text <- 
      paste0("cross_correlation_distance_hclust_vaccination_c37_dengrogram_current <- as.dendrogram(cross_correlation_distance_hclust_vaccination_c37_", method_current, "_fold_", cv_current_index, ")") 
    # running 
    ...
    for ( correlation_current in c(1:length(correlations_list)) )
    {
      ...
      # Saving object
      object_creation_for_current_correlation_and_fold_code <- paste0("ccd_correlation_", correlations_list[correlation_current] , "_", method_current, "_fold_", cv_current_index, " <- cor_dendlist_current") 
      eval(parse(text = object_creation_for_current_correlation_and_fold_code))    
      
      # Path to save
      path_to_save_object <- paste0("../R_Data/ccd_correlation_", correlations_list[correlation_current] , "_", method_current, "_fold_", cv_current_index, ".RData") 
      # Saving process
      saving_process_command <- paste0( "save( ccd_correlation_", correlations_list[correlation_current] , "_", method_current, "_fold_", cv_current_index, ", file = path_to_save_object )" )
