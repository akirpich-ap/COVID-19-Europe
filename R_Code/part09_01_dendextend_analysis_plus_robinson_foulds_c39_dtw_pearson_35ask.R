...
design_frame$dend1[1]   <- "dynamic_time_wapping_hclust_mortality_c39_dengrogram_current"
...
design_frame$dend1[2]   <- "dynamic_time_wapping_hclust_mortality_c39_dengrogram_current"
...
#
design_frame$dend2[2]  <- "dynamic_time_wapping_hclust_vaccination_c39_dengrogram_current"
...
design_frame$dend1[3]   <- "dynamic_time_wapping_hclust_mortality_c39_dengrogram_current"
...
design_frame$dend1[4]  <- "dynamic_time_wapping_hclust_vaccination_c39_dengrogram_current"
...
design_frame$dend1[5]  <- "dynamic_time_wapping_hclust_vaccination_c39_dengrogram_current"
...
#
design_frame$dend2[6]   <- "dynamic_time_wapping_hclust_incidence_c39_dengrogram_current"
...
#
design_frame$dend2[7]   <- "dynamic_time_wapping_hclust_incidence_c39_dengrogram_current"
...
design_frame$dend1[8]  <- "dynamic_time_wapping_hclust_vaccination_c39_dengrogram_current"
...
#
design_frame$dend2[8]   <- "dynamic_time_wapping_hclust_mortality_c39_dengrogram_current"
...
design_frame$dend1[9]  <- "dynamic_time_wapping_hclust_incidence_c39_dengrogram_current"
...
#
design_frame$dend2[9]   <- "dynamic_time_wapping_hclust_vaccination_c39_dengrogram_current"
...
design_frame$dend1[10]  <- "dynamic_time_wapping_hclust_incidence_c39_dengrogram_current"
...
for (method_current in hclust_methods)
{
  ...
  for ( index_current in c(1:dim(design_frame)[1]) )
  {
    ...
    # The code below doe snot work correctly if the number of labels are different in different deprograms.
    # Extra check is necessary to address that
    
    # Same labels here
    if( length(labels(dend1_dend2_list[[1]])) == length(labels(dend1_dend2_list[[2]])) )
    {
      ...
      # End of -> if( length(labels(dend1_dend2_list[[1]])) == length(labels(dend1_dend2_list[[2]])) )  
    }
  ...
  for ( correlation_current in c(1:length(correlations_list)) )
  {
    ...
    for ( visualization_current in c(1:length(visualizations_list)) )
    {
      ...
      # Generating pdf output.
      pdf(paste("../Plots/part09_01_corrplot_dtw_all_lower_", method_current, "_", correlations_list[correlation_current], "_", visualizations_list[visualization_current], "_pearson_c39.pdf", sep = ""), height = 10, width = 10)
      ...
      # Generating pdf output.
      pdf(paste("../Plots/part09_01_corrplot_dtw_all_full_", method_current, "_", correlations_list[correlation_current], "_", visualizations_list[visualization_current], "_pearson_c39.pdf", sep = ""), height = 10, width = 10)
  ...
  for ( visualization_current in c(1:length(visualizations_list)) )
  {
    ...
    # Generating pdf output.
    pdf(paste("../Plots/part09_01_corrplot_dtw_all_lower_", method_current, "_cophenetic_and_baker_" , visualizations_list[visualization_current], "_pearson_c39.pdf", sep = ""), height = 10, width = 20)
    ...
    # Exporting CSV files
    cor_dendlist_current_csv_path = paste0("../R_Output/part09_01_correlation_cophenetic_dtw_", method_current, "_c39.csv")
    ...
    # Exporting CSV files
    cor_dendlist_current_csv_path = paste0("../R_Output/part09_01_correlation_baker_dtw_", method_current, "_c39.csv")
    cor_dendlist_current_frame <- data.frame(Data = rownames(cor_dendlist_current), cor_dendlist_current)
    names(cor_dendlist_current_frame) <- c("Data", rownames(cor_dendlist_current))
    write.table(x = cor_dendlist_current_frame, file = cor_dendlist_current_csv_path, sep = ",", row.names = FALSE, col.names = TRUE)
    ...
    # Generating pdf output.
    pdf(paste("../Plots/part09_01_corrplot_dtw_all_upper_", method_current, "_cophenetic_and_baker_" , visualizations_list[visualization_current], "_pearson_c39.pdf", sep = ""), height = 10, width = 20)
    # par(par(mfrow = c(1, 2)), mar = c(16.5, 5.1, 6, 2.1))
    par(mfrow = c(1, 2))
    ...
    # Generating pdf output.
    pdf(paste("../Plots/part09_01_corrplot_dtw_all_full_", method_current, "_cophenetic_and_baker_" , visualizations_list[visualization_current], "_pearson_c39.pdf", sep = ""), height = 10, width = 20)
    # par(par(mfrow = c(1, 2)), mar = c(16.5, 5.1, 6, 2.1))
    par(mfrow = c(1, 2))
  ...
  sink(paste0("../R_Output/part09_01_rob_foulds_dtw_", method_current, "_c39.txt"))
  ...
  # Exporting CSV files
  # Regular
  robinson_foulds_current_csv_path = paste0("../R_Output/part09_01_rob_foulds_dtw_", method_current, "_c39.csv")
  write.table(x = robinson_foulds_current, file = robinson_foulds_current_csv_path, sep = ",", row.names = TRUE)
  # Standardized
  robinson_foulds_standardized_current_csv_path = paste0("../R_Output/part09_01_rob_foulds_dtw_standardized_", method_current, "_c39.csv")
  ...
  # Creating a path 
  robinson_foulds_current_xtable_path_out <- paste0("../R_Output/part09_01_rob_foulds_dtw_", method_current, "_c39.tex")
  # Printing
  ...
  # Exporting as tex file
  # Creating a path 
  robinson_foulds_standardized_current_xtable_path_out <- paste0("../R_Output/part09_01_rob_foulds_dtw_standardized_", method_current, "_c39.tex")
  # Printing
